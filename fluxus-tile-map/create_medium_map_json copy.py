...
def create_grid_overlay_data():
    ...
    # Add category boundaries and headers
...
def create_bare_bones_medium_map():
    """Create a simplified medium map with dense packing of tiles."""
    print("Starting simplified medium map creation")
